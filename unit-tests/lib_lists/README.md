...
- `test_flist_push_front` - Add nodes at the beginning
- `test_flist_push_back` - Add nodes at the end
- `test_flist_pop_front` - Remove nodes from the beginning
- `test_flist_pop_back` - Remove nodes from the end
- `test_flist_insert_after` - Insert after a reference node
- `test_flist_remove` - Remove specific nodes
- `test_flist_remove_if` - Remove nodes matching predicate
- `test_flist_clear` - Clear entire list
- `test_flist_sort` - Sort list with comparison function
- `test_flist_unique` - Remove duplicate consecutive nodes
- `test_flist_reverse` - Reverse list order
...
```bash
[==========] Running 24 test(s).
[ RUN      ] test_flist_push_front
[       OK ] test_flist_push_front
[ RUN      ] test_flist_push_back
[       OK ] test_flist_push_back
[ RUN      ] test_flist_pop_front
[       OK ] test_flist_pop_front
...
