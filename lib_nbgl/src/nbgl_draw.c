                             ...
                             color_t            fontColor)
{
    ...
    if (!strcmp(original_text, "แบตเตอรี่ต่ำจนวิกฤต")) {
        fprintf(stdout,
    ...
    while (textLen > 0 || next_char.unicode) {
        ...
        // Compute next x with current char width, to be ready to display next one
            ...
            if (!strcmp(original_text, "แบตเตอรี่ต่ำจนวิกฤต") && current_char.unicode >= 0x000E00
            ...
            if (!strcmp(original_text, "แบตเตอรี่ต่ำจนวิกฤต") && current_char.over_previous) {
            ...
            if (!strcmp(original_text, "แบตเตอรี่ต่ำจนวิกฤต")
                && ((current_char.unicode == 0x000E48 && next_char.unicode == 0x000E15)
                    || current_char.unicode == 0x000E33)) {
