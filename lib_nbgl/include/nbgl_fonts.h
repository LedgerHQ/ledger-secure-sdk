...
#define SMALL_REGULAR_FONT      BAGL_FONT_INTER_MEDIUM_18px_1bpp
#define SMALL_BOLD_FONT         BAGL_FONT_INTER_BOLD_18px_1bpp
#define LARGE_MEDIUM_FONT       BAGL_FONT_INTER_SEMIBOLD_24px_1bpp
#define SMALL_REGULAR_1BPP_FONT BAGL_FONT_INTER_MEDIUM_18px_1bpp
#define SMALL_BOLD_1BPP_FONT    BAGL_FONT_INTER_BOLD_18px_1bpp
#define LARGE_MEDIUM_1BPP_FONT  BAGL_FONT_INTER_SEMIBOLD_24px_1bpp
...
typedef enum {
    ...
    BAGL_FONT_INTER_MEDIUM_18px_1bpp        = 17u,  // on Apex
    BAGL_FONT_INTER_BOLD_18px_1bpp          = 18u,  // on Apex
