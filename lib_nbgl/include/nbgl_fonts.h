...
#define LARGE_OBFUSCATED_MEDIUM_FONT      BAGL_FONT_OBFUSCATED_INTER_MEDIUM_32px
...
#define SMALL_OBFUSCATED_BOLD_1BPP_FONT   BAGL_FONT_OBFUSCATED_INTER_SEMIBOLD_24px_1bpp
#define LARGE_MEDIUM_1BPP_FONT            BAGL_FONT_INTER_MEDIUM_32px_1bpp
#define LARGE_OBFUSCATED_MEDIUM_1BPP_FONT BAGL_FONT_OBFUSCATED_INTER_MEDIUM_32px_1bpp
...
#define LARGE_OBFUSCATED_MEDIUM_FONT      BAGL_FONT_OBFUSCATED_INTER_MEDIUM_36px
...
#define SMALL_OBFUSCATED_BOLD_1BPP_FONT   BAGL_FONT_OBFUSCATED_INTER_SEMIBOLD_28px_1bpp
#define LARGE_MEDIUM_1BPP_FONT            BAGL_FONT_INTER_MEDIUM_36px_1bpp
#define LARGE_OBFUSCATED_MEDIUM_1BPP_FONT BAGL_FONT_OBFUSCATED_INTER_MEDIUM_36px_1bpp
#elif SMALL_FONT_HEIGHT == 18
#define SMALL_REGULAR_FONT                BAGL_FONT_NANOTEXT_MEDIUM_18px_1bpp
#define SMALL_BOLD_FONT                   BAGL_FONT_NANOTEXT_BOLD_18px_1bpp
#define LARGE_MEDIUM_FONT                 BAGL_FONT_NANODISPLAY_SEMIBOLD_24px_1bpp
#define LARGE_OBFUSCATED_MEDIUM_FONT      BAGL_FONT_OBFUSCATED_NANODISPLAY_SEMIBOLD_24px_1bpp
#define SMALL_REGULAR_1BPP_FONT           BAGL_FONT_NANOTEXT_MEDIUM_18px_1bpp
#define SMALL_BOLD_1BPP_FONT              BAGL_FONT_NANOTEXT_BOLD_18px_1bpp
#define SMALL_OBFUSCATED_BOLD_1BPP_FONT   BAGL_FONT_OBFUSCATED_NANOTEXT_BOLD_18px_1bpp
#define LARGE_MEDIUM_1BPP_FONT            BAGL_FONT_NANODISPLAY_SEMIBOLD_24px_1bpp
#define LARGE_OBFUSCATED_MEDIUM_1BPP_FONT BAGL_FONT_OBFUSCATED_NANODISPLAY_SEMIBOLD_24px_1bpp
...
typedef enum {
    ...
    BAGL_FONT_NANOTEXT_MEDIUM_18px_1bpp      = 17u,  // on Apex
    BAGL_FONT_NANOTEXT_BOLD_18px_1bpp        = 18u,  // on Apex
    BAGL_FONT_NANODISPLAY_SEMIBOLD_24px_1bpp = 19u,  // on Apex

    // OBFSUCATED FONTS
    BAGL_FONT_OBFUSCATED_INTER_REGULAR_24px,
    BAGL_FONT_OBFUSCATED_INTER_SEMIBOLD_24px,
    BAGL_FONT_OBFUSCATED_INTER_MEDIUM_32px,
    BAGL_FONT_OBFUSCATED_INTER_REGULAR_24px_1bpp,
    BAGL_FONT_OBFUSCATED_INTER_SEMIBOLD_24px_1bpp,
    BAGL_FONT_OBFUSCATED_INTER_MEDIUM_32px_1bpp,
    BAGL_FONT_OBFUSCATED_OPEN_SANS_EXTRABOLD_11px_1bpp,
    BAGL_FONT_OBFUSCATED_OPEN_SANS_LIGHT_16px_1bpp,
    BAGL_FONT_OBFUSCATED_OPEN_SANS_REGULAR_11px_1bpp,
    BAGL_FONT_OBFUSCATED_INTER_REGULAR_28px,
    BAGL_FONT_OBFUSCATED_INTER_SEMIBOLD_28px,
    BAGL_FONT_OBFUSCATED_INTER_MEDIUM_36px,
    BAGL_FONT_OBFUSCATED_INTER_REGULAR_28px_1bpp,
    BAGL_FONT_OBFUSCATED_INTER_SEMIBOLD_28px_1bpp,
    BAGL_FONT_OBFUSCATED_INTER_MEDIUM_36px_1bpp,
    BAGL_FONT_OBFUSCATED_NANOTEXT_MEDIUM_18px_1bpp,
    BAGL_FONT_OBFUSCATED_NANOTEXT_BOLD_18px_1bpp,
    BAGL_FONT_OBFUSCATED_NANODISPLAY_SEMIBOLD_24px_1bpp,
