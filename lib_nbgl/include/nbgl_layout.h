...
#else // HAVE_SE_TOUCH
    nbgl_layoutButtonCallback_t onActionCallback; ///< the callback to be called on any action on the layout
#endif // HAVE_SE_TOUCH
...
/**
 * @brief This structure contains a list of names to build a menu list on Nanos, with for each item a description (names array)
 */
typedef struct {
