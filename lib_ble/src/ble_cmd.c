...
{
    if ((!cmd_data) || (!datas) || (datas->local_name_length > BLE_GAP_MAX_LOCAL_NAME_LENGTH)) {
        return;
    }
    ...
    U2LE_ENCODE(
        cmd_data->hci_cmd_buffer, cmd_data->hci_cmd_buffer_length, datas->advertising_interval_min);
    cmd_data->hci_cmd_buffer_length += 2;
    // Advertising_Interval_Max
    U2LE_ENCODE(
        cmd_data->hci_cmd_buffer, cmd_data->hci_cmd_buffer_length, datas->advertising_interval_max);
    cmd_data->hci_cmd_buffer_length += 2;
    // Own_Address_Type
    ...
    U2LE_ENCODE(
        cmd_data->hci_cmd_buffer, cmd_data->hci_cmd_buffer_length, datas->slave_conn_interval_min);
    cmd_data->hci_cmd_buffer_length += 2;
    // Slave_Conn_Interval_Max
    U2LE_ENCODE(
        cmd_data->hci_cmd_buffer, cmd_data->hci_cmd_buffer_length, datas->slave_conn_interval_max);
    cmd_data->hci_cmd_buffer_length += 2;
}
...
void ble_aci_gatt_forge_cmd_add_char(ble_cmd_data_t *cmd_data, ble_cmd_add_char_data_t *datas)
{
    if ((!cmd_data) || (!datas) || (!datas->char_uuid)) {
        return;
    }
    ...
    // Char_Value_Length
    U2LE_ENCODE(
        cmd_data->hci_cmd_buffer, cmd_data->hci_cmd_buffer_length, datas->char_value_length);
    cmd_data->hci_cmd_buffer_length += 2;
    // Char_Properties
