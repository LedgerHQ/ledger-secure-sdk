...
add_library(ledger_fuzz_macros INTERFACE)

# Detect if CMAKE_SOURCE_DIR is inside the SDK v2 fuzzing tree (sdk-fuzz or similar).
...
if(_SDK_FUZZ_PREFIX_POS EQUAL -1 AND NOT "${BOLOS_SDK}/fuzzing" STREQUAL "${CMAKE_SOURCE_DIR}")
  ...
  set(DEFINES_MAKEFILE_DIRECTORY "${BOLOS_SDK}/fuzzing/v2/macros")
endif()
...
target_compile_definitions(ledger_fuzz_macros INTERFACE ${MACRO_LIST})
