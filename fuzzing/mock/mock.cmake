...
# IMPORTANT NOTE:
#
# When globbing source files from the mock directory, it is **critical** that the
# "custom" folder appears **alphabetically before** the "generated" folder.
#
# This is because the symbols are **statically linked**, and the linker
# resolves symbols in the **order they appear** in the source list. By ensuring that
# the custom implementations come first, we allow them to **override** the
# symbols from the generated mocks.
#
# Failing to maintain this order may result in the linker choosing the wrong symbol,
# and using the generated mocks instead of the custom ones.
# -----------------------------------------------------------------------------------
include_guard()
