...
USBD_StatusTypeDef USBD_LEDGER_WEBUSB_de_init(USBD_HandleTypeDef *pdev, void *cookie)
{
    UNUSED(pdev);
    UNUSED(cookie);
...
USBD_StatusTypeDef USBD_LEDGER_WEBUSB_ep0_rx_ready(USBD_HandleTypeDef *pdev, void *cookie)
{
    UNUSED(pdev);
    UNUSED(cookie);
