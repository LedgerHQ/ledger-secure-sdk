...
static u2f_settings_t          ledger_hid_u2f_settings;
...
const uint8_t LEDGER_HID_U2F_report_descriptor[34] = {
    ...
    // The Input report
    0x09, 0x03,                      // Usage ID        : FIDO_USAGE_DATA_IN
    0x15, 0x00,                      // Logical Minimum : 0
    0x26, 0xFF, 0x00,                // Logical Maximum : 255
    0x75, 0x08,                      // Report Size     : 8 bits
    0x95, LEDGER_HID_U2F_EPIN_SIZE,  // Report Count    : 64 fields
    0x81, 0x08,                      // Input           : Data, Variable, Absolute, No Wrap

    // The Output report
    0x09, 0x04,                      // Usage ID        : FIDO_USAGE_DATA_OUT
    0x15, 0x00,                      // Logical Minimum : 0
    0x26, 0xFF, 0x00,                // Logical Maximum : 255
    0x75, 0x08,                      // Report Size     : 8 bits
    0x95, LEDGER_HID_U2F_EPOUT_SIZE, // Report Count    : 64 fields
    0x91, 0x08,                      // Output          : Data, Variable, Absolute, No Wrap
                                     ...
                                     uint16_t            packet_length)
{
    ...
    PRINTF("USBD_LEDGER_HID_U2F_data_out");
    ...
    switch (packet_type) {
        case OS_IO_PACKET_TYPE_USB_U2F_HID_APDU:
            ...
            if ((message_length == 2) && (message[0] == 0x69) && (message[1] == 0x85)) {
                ...
                PRINTF("LEDGER_HID_U2F_USER_PRESENCE_ASKING");
            }
                ...
                PRINTF("LEDGER_HID_U2F_USER_PRESENCE_CONFIRMED");
                return USBD_OK;
            }
            break;
                                       ...
                                       uint16_t            max_length)
{
    ...
    PRINTF("USBD_LEDGER_HID_U2F_data_ready");
