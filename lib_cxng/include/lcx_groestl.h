 ...
 *                     - CX_INVALID_PARAMETER
 */
WARN_UNUSED_RESULT cx_err_t cx_groestl(cx_groestl_t *hash, uint32_t mode, const uint8_t *in, size_t len, uint8_t *out, size_t out_len);
 ...
 *                    - CX_OK on success
 */
WARN_UNUSED_RESULT cx_err_t cx_groestl_final(cx_groestl_t *ctx, uint8_t *digest);
