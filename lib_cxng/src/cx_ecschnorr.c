...
#define H G_cx.sha256
  ...
  if ((mode & CX_MASK_EC) == CX_ECSCHNORR_BIP0340) {
    ...
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST, BIP0340_aux, sizeof(BIP0340_aux), R, size));
    cx_sha256_init_no_throw(&H);
    ...
    cx_sha256_init_no_throw(&H);
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST, BIP0340_nonce, sizeof(BIP0340_nonce), R, size));
    cx_sha256_init_no_throw(&H);
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, R, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, R, size, NULL, 0));
 ...
 RETRY2:
  ...
  case CX_ECSCHNORR_ISO14888_X:
    ...
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST | CX_NO_REINIT, msg, msg_len, R, sizeof(R)));
  ...
  case CX_ECSCHNORR_BSI03111:
    ...
    CX_CHECK(cx_ecpoint_export(&Q, sig, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST | CX_NO_REINIT, sig, size, R, sizeof(R)));
  ...
  case CX_ECSCHNORR_LIBSECP:
    ...
    cx_sha256_init_no_throw(&H);
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, R, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST | CX_NO_REINIT, msg, msg_len, sig, sizeof(S)));
  ...
  ** https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki */
  ...
  case CX_ECSCHNORR_BIP0340:
    ...
    cx_sha256_init_no_throw(&H);
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST, BIP0340_challenge, sizeof(BIP0340_challenge), sig, size));
    cx_sha256_init_no_throw(&H);
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, sig, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, sig, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, R, size, NULL, 0));
...
bool cx_ecschnorr_verify(const cx_ecfp_public_key_t *pu_key,
  ...
  case CX_ECSCHNORR_ISO14888_X:
    ...
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST | CX_NO_REINIT, msg, msg_len, x, sizeof(x)));
    // 4.
  ...
  case CX_ECSCHNORR_BSI03111:
    ...
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, msg, msg_len, NULL, 0));
    CX_CHECK(cx_ecpoint_export(&R, x, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST | CX_NO_REINIT, x, size, x, sizeof(x)));
    // 4.
    CX_CHECK(cx_bn_init(bn_s, x, CX_SHA256_SIZE));
    CX_CHECK(cx_bn_cmp(bn_r, bn_s, &diff));
    if (diff == 0) {
  ...
  case CX_ECSCHNORR_Z:
    ...
    // m
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST | CX_NO_REINIT, msg, msg_len, x, sizeof(x))); // m
  ...
  ** https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki */
  ...
  case CX_ECSCHNORR_BIP0340:
    ...
    cx_sha256_init_no_throw(&H);
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST, BIP0340_challenge, sizeof(BIP0340_challenge), x, size));
    cx_sha256_init_no_throw(&H);
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, x, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, x, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, sig, size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, 0, &pu_key->W[1], size, NULL, 0));
    CX_CHECK(cx_hash_no_throw((cx_hash_t *)&H, CX_LAST | CX_NO_REINIT, msg, msg_len, x, size));
    // e = e % n
