...
/** Return true if the curve identifier is in the specified range @hideinitializer */
...
/**
 * @brief   Initialize a point on the curve with the BN indexes of the coordinates.
 *
 * @param[in] P Pointer to the point to initialize.
 *
 ...
 *                               This should be equal to twice of the length of one coordinate
 *                               plus one byte for the prefix.
 *
...
/**
 * @brief   Perform a secure scalar multiplication given the BN index of the scalar.
 *
 * @param[in, out] P    Pointer to a point on a curve. This will hold the result.
 *
...
/**
 * @brief   Perform a double scalar multiplication given the BN indexes of the scalars.
 *
 * @details This implements the Straus-Shamir algorithm for computing **R = [k]P + [r]Q**.
 *          This should be used only for non-secret computations.
 *
