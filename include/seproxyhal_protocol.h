...
enum seph_protocol_cmd_ux_type {
    SEPROXYHAL_TAG_UX_CMD_BLE_DISABLE_ADV       = 0x00,
    SEPROXYHAL_TAG_UX_CMD_BLE_ENABLE_ADV        = 0x01,
    SEPROXYHAL_TAG_UX_CMD_BLE_RESET_PAIRINGS    = 0x02,
    SEPROXYHAL_TAG_UX_CMD_REDISPLAY             = 0x03,
    SEPROXYHAL_TAG_UX_CMD_BLE_NAME_CHANGED      = 0x04,
    SEPROXYHAL_TAG_UX_CMD_ACCEPT_PAIRING        = 0x05,
    SEPROXYHAL_TAG_UX_CMD_OS_UX                 = 0x06,
    SEPROXYHAL_TAG_UX_CMD_BLE_UX_PAIRING_ASK    = 0x07,
    SEPROXYHAL_TAG_UX_CMD_BLE_UX_PAIRING_STATUS = 0x08,
};
