...
#define OS_SETTING_FEATURES_NFC_ENABLED_OFFSET    0x0
#define OS_SETTING_FEATURES_NFC_ENABLED           (1 << OS_SETTING_FEATURES_NFC_ENABLED_OFFSET)
// if (os_settings[OS_SETTING_FEATURES] & OS_SETTING_FEATURES_NO_PIN_SHUFFLE) then PIN shuffle is
// disabled
#define OS_SETTING_FEATURES_NO_PIN_SHUFFLE_OFFSET 0x1
#define OS_SETTING_FEATURES_NO_PIN_SHUFFLE        (1 << OS_SETTING_FEATURES_NO_PIN_SHUFFLE_OFFSET)
...
#define FEATURES_DEFAULT_VALUE                                                    \
    ((FEATURES_DEFAULT_NFC_ENABLED << OS_SETTING_FEATURES_NFC_ENABLED_OFFSET)     \
     | (FEATURES_DEFAULT_BATT_IN_SIDE << OS_SETTING_FEATURES_BATT_IN_SIDE_OFFSET) \
     | (FEATURES_DEFAULT_NO_PIN_SHUFFLE << OS_SETTING_FEATURES_NO_PIN_SHUFFLE_OFFSET))
