 ...
 */
SYSCALL PERMISSION(APPLICATION_FLAG_BOLOS_UX) bolos_bool_t os_aem_is_pin_set(void);
 ...
 */
SYSCALL PERMISSION(APPLICATION_FLAG_BOLOS_UX) bolos_bool_t os_aem_is_response_active(void);
 ...
 * (depending on the failed internal check).
 */
SYSCALL PERMISSION(APPLICATION_FLAG_BOLOS_UX) bolos_bool_t os_aem_is_feature_active(void);
 ...
 */
SYSCALL PERMISSION(APPLICATION_FLAG_BOLOS_UX) unsigned char os_aem_get_response_length(void);

/**
 * This function allows one to retrieve the format of the response.
 * @return The format of the currently stored response.
 */
SYSCALL PERMISSION(APPLICATION_FLAG_BOLOS_UX) unsigned char os_aem_get_response_format(void);
 ...
 * AEM PIN is not set.
 */
SYSCALL PERMISSION(APPLICATION_FLAG_GLOBAL_PIN) unsigned int os_aem_get_ptc(void);
