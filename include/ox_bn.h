 ...
 *
 * @details To mark BN as unset/unused in wrapping structure, such as cx_ecpoint_t.
 */
...
/**
 * @brief   Store/Serialize a BN value as unsigned raw bytes in big-endian order.
 *
...
/**
 * @brief   Compute *r* such that **r² = a mod n** if *a* is a quadratic residue.
 *
