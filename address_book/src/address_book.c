 ...
 *  - P1 0x02  → Rename Identity     (always active)
 *  - P1 0x03  → Register Ledger Account  (HAVE_ADDRESS_BOOK_LEDGER_ACCOUNT)
 *  - P1 0x04  → Rename Ledger Account    (HAVE_ADDRESS_BOOK_LEDGER_ACCOUNT)
 */
...
#define P1_RENAME_IDENTITY   0x02
