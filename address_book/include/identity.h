...
/* Exported defines   --------------------------------------------------------*/
#define TYPE_REGISTER_IDENTITY 0x2d
#define TYPE_EDIT_CONTACT_NAME 0x2e
#define TYPE_EDIT_IDENTIFIER   0x31
#define TYPE_EDIT_SCOPE        0x32
#define TYPE_PROVIDE_CONTACT   0x33
