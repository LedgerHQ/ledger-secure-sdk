 ...
 * @warning Deprecated function. Please use \ref ENDORSEMENT_key2_derive_and_sign_data instead.
 */
                                                  ...
                                                  unsigned char *signature)
{
    uint32_t    out_signature_length = 0;
    bolos_err_t error
        = ENDORSEMENT_key2_derive_and_sign_data(src, srcLength, signature, &out_signature_length);
