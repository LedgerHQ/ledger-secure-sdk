...
__attribute((weak)) int os_io_rx_evt_until(unsigned char *buffer,
                                           unsigned short buffer_max_length,
                                           unsigned int  *timeout_ms,
                                           bool           check_se_event)
{
    ...
    parameters[2] = (unsigned int) timeout_ms;
    parameters[3] = (unsigned int) check_se_event;
    return (int) SVC_Call(SYSCALL_os_io_rx_evt_until_ID, parameters);
}
...
{
    unsigned int parameters[4];
    parameters[0] = (unsigned int) salt_id;
    parameters[1] = (unsigned int) message;
    parameters[2] = (unsigned int) message_len;
    parameters[3] = (unsigned int) hmac_out;
                                  ...
                                  const uint8_t          hmac_expected[CX_SHA256_SIZE])
{
    ...
    parameters[1] = (unsigned int) message;
    parameters[2] = (unsigned int) message_len;
    parameters[3] = (unsigned int) hmac_expected;
