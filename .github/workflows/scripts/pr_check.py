...
def clone_repo(github_url: str, local_path: str, token: str) -> None:
    ...
    logger.info("Cloning repo from %s to %s", github_url, local_path)
...
def cherry_pick_commits(repo_path: str, commits: List[str], auto_branch: str, dry_run: bool = False) -> None:
...
def main():
    ...
    for target_br in target_branches:
        ...
        with tempfile.TemporaryDirectory() as local_repo_path:
            ...
            cherry_pick_commits(local_repo_path, commits, auto_branch, args.dry_run)
